...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView gameLauncherTextView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        gameLauncherTextView = findViewById(R.id.default_game_text_view);
        gameLauncherTextView.setOnClickListener(new View.OnClickListener() {
            @Override
